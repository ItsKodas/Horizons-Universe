...
namespace Spawn
{
    public class ACSpace
    {
        ...
        private static Vector3D RegionCenter = new Vector3D(-1801336.64, 86848.78, 1115550.61); //This is XYZ coords of the region center. This can be pulled from Nexus Controller Sectorsetup.
        private static double RegionRadius = 350; //Radius is in KM. This also can be pulled from Controller SectorSetup
