...
namespace Spawn
{
    public class SolSpace
    {
        ...
        private static Vector3D RegionCenter = new Vector3D(61353.68, 468847.08, 194222.23); //This is XYZ coords of the region center. This can be pulled from Nexus Controller Sectorsetup.
        private static double RegionRadius = 640; //Radius is in KM. This also can be pulled from Controller SectorSetup
